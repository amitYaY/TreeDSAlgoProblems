...
public class SolutionService7 {
    ...
    public static void main(String[] args) {
        ...
        Boolean flag = checkMirror(root1, root2);
        System.out.println("Mirror: " + flag);
        ...
        flag = checkMirror(root1, root3);
        System.out.println("Mirror: " + flag);
    }

    private static Boolean checkMirror(BinaryTree root1, BinaryTree root2) {
